...
if ((isset($_SESSION['admin']) or isset($_SESSION['Patient'])) and isset($_GET['id'])) {
    ...
    $G1Query = "Select * from m_general_assessment_1 where MSA_Id='$MSA_Id'";
    $G1Result = mysqli_query($conn, $G1Query);
    $G1Row = mysqli_fetch_row($G1Result);

    $G2Query = "Select * from m_general_assessment_2 where MSA_Id='$MSA_Id'";
    $G2Result = mysqli_query($conn, $G2Query);
    $G2Row = mysqli_fetch_row($G2Result);

    $ThQuery = "Select * from m_thyroid_assessment where MSA_Id='$MSA_Id'";
    $ThResult = mysqli_query($conn, $ThQuery);
    $ThRow = mysqli_fetch_row($ThResult);

    $StrQuery = "Select * from m_stress_assessment where MSA_Id='$MSA_Id'";
    $StrResult = mysqli_query($conn, $StrQuery);
    $StrRow = mysqli_fetch_row($StrResult);

    $HQuery = "Select * from m_hormone_assessment where MSA_Id='$MSA_Id'";
    $HResult = mysqli_query($conn, $HQuery);
    $HRow = mysqli_fetch_row($HResult);

    $T1Query = "Select * from m_toxic_assessment_1 where MSA_Id='$MSA_Id'";
    $T1Result = mysqli_query($conn, $T1Query);
    $T1Row = mysqli_fetch_row($T1Result);

    $T2Query = "Select * from m_toxic_assessment_2 where MSA_Id='$MSA_Id'";
    $T2Result = mysqli_query($conn, $T2Query);
    $T2Row = mysqli_fetch_row($T2Result);

    $T3Query = "Select * from m_toxic_assessment_3 where MSA_Id='$MSA_Id'";
    $T3Result = mysqli_query($conn, $T3Query);
    $T3Row = mysqli_fetch_row($T3Result);

    $CQuery = "Select * from m_consumption_assessment where MSA_Id='$MSA_Id'";
                ...
                <table class="table table-hover table-bordered ">
                    <tbody>
                        ...
                        <tr>
                            ...
                            if ($G2Row[3] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($G2Row[3] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="g2Testosterone" value="Never" disabled /> Never</td>
                ...
                <table class="table table-hover table-bordered ">
                    <tbody>
                        ...
                        <tr>
                            ...
                            if ($HRow[10] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($HRow[10] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hfatty" value="Never" disabled /> Never</td>
                        ...
                        <tr>
                            ...
                            if ($HRow[11] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($HRow[11] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hSoft" value="Never" disabled /> Never</td>
                        ...
                        <tr>
                            ...
                            if ($HRow[12] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($HRow[12] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hMuscle" value="Never" disabled /> Never</td>
                        ...
                        <tr>
                            ...
                            if ($HRow[13] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($HRow[13] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hStamina" value="Never" disabled /> Never</td>
                        ...
                        <tr>
                            ...
                            if ($HRow[14] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($HRow[14] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hHeadache" value="Never" disabled /> Never</td>
                        ...
                        <tr>
                            ...
                            if ($HRow[15] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($HRow[15] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hProstate" value="Never" disabled /> Never</td>
                        ...
                        <tr>
                            ...
                            if ($HRow[16] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($HRow[16] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hUrination" value="Never" disabled /> Never</td>
                        ...
                        <tr>
                            ...
                            if ($HRow[17] == "Never") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Never" Checked /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Often" disabled /> Often</td>
                            <?php
                            } else if ($HRow[17] == "Rearly") {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Rearly" Checked /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Never" disabled /> Never</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Sometimes" Checked /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Often" disabled /> Often</td>
                            <?php
                            ...
                            ?>
                                ...
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Rearly" disabled /> Rearly</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Sometimes" disabled /> Sometimes</td>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Often" Checked /> Often</td>
                            <?php
                            } else {
                            ?>
                                <td style="font-size: 13px;"><input type="radio" name="hFoggy" value="Never" disabled /> Never</td>
